...
class VideoOverlayFolder extends Model
{
    use SoftDeletes;

    protected $table = 'video_overlay_folders';
    ...
    {
        return $this->belongsTo(VideoOverlayFolder::class, 'parent_id');
    }
    ...
    {
        return $this->hasMany(VideoOverlayFolder::class, 'parent_id');
    }

    /**
     * Get all video overlays in this folder
     */
    public function videoOverlays(): HasMany
    {
        return $this->hasMany(VideoOverlay::class, 'folder_id');
    }

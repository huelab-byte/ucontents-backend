...
class ImageOverlayFolder extends Model
{
    use SoftDeletes;

    protected $table = 'image_overlay_folders';
    ...
    {
        return $this->belongsTo(ImageOverlayFolder::class, 'parent_id');
    }
    ...
    {
        return $this->hasMany(ImageOverlayFolder::class, 'parent_id');
    }

    /**
     * Image overlays in folder relationship
     */
    public function imageOverlays(): HasMany
    {
        return $this->hasMany(ImageOverlay::class, 'folder_id');
    }

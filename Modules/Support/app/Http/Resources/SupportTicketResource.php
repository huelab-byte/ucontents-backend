...
class SupportTicketResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'last_replied_at' => $this->last_replied_at?->toISOString(),
            'last_replied_by' => $this->whenLoaded('lastRepliedBy', fn () => [
            ...
            'public_replies' => $this->whenLoaded('publicReplies', fn () => SupportTicketReplyResource::collection($this->publicReplies)),

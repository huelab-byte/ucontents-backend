...
class AudioFolder extends Model
{
    use SoftDeletes;
    ...
    {
        return $this->belongsTo(AudioFolder::class, 'parent_id');
    }
    ...
    {
        return $this->hasMany(AudioFolder::class, 'parent_id');
    }

    /**
     * Get all audio in this folder
     */
    public function audio(): HasMany
    {
        return $this->hasMany(Audio::class, 'folder_id');
    }

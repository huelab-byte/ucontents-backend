...
namespace Modules\EmailManagement\Providers;
...
use Modules\EmailManagement\Policies\EmailTemplatePolicy;
use Modules\EmailManagement\Policies\SmtpConfigurationPolicy;
...
class EmailManagementServiceProvider extends ServiceProvider
{
    ...
    protected string $name = 'EmailManagement';

    protected string $nameLower = 'emailmanagement';
    ...
    public function register(): void
    {
        ...
        $this->app->singleton('email.service', function ($app) {
            return new \Modules\EmailManagement\Services\EmailService();
        });
    }
